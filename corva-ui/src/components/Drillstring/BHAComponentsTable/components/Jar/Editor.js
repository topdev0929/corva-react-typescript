...
import { JAR_SUB_CATEGORIES, COMPONENT_MATERIALS } from '~/constants/drillstring';
...
function Jar({ component, error, onChange, onCancel, onSave, columns }) {
