...
import OffsetAssetChip from './OffsetAssetChip';
  ...
  return (
    <>
      <OffsetAssetChip
        ...
        handleClick={isStageDataEmpty ? noop : openDialog}
        disabled={isStageDataEmpty}
        tooltipText={`Edit stages for ${offset.selectedWellName}`}
      >
        {offset.selectedWellName}
      </OffsetAssetChip>
