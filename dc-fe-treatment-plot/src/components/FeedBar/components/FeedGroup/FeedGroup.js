...
function getAvatarContent(comments) {
  ...
  if (feedItemIcon !== AVATAR_ICON) {
    return <img className="feedGroupTypeIcon" alt="feed group" src={feedItemIcon} />;
  }
...
function FeedGroup({ comments, position, isTooltipOpened, onTooltipOpened, currentUser }) {
  ...
  return (
    <>
      ...
      >
        <MuiAvatar
          className={classNames('feedGroupIcon', isTooltipOpened && 'feedGroupIconActive')}
      ...
      >
        <div
          className="feedGroupItemsContainer"
