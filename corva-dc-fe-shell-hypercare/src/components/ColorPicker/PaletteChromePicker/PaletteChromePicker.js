...
const useStyles = makeStyles({
  ...
  icon: { color: '#dadada', fontSize: '24px' },
...
const PaletteChromePicker = forwardRef(({ color, onChange, onSizeChange }, ref) => {
  ...
  return (
    <div className={classes.container} ref={ref}>
      {pickMode === COLOR_PICK_MODE.PALETTE && (
        <Palette className={classes.chomePickerPalette} color={color} onChange={onChange} />
      )}
